const inputNode = async (params) => {
    ...
    <div id="inputNode" class="flex justify-center items-center flex-col">
             ...
             <div class="input-button-container flex justify-center gap-4">
                <div class="input-button w-56 h-16 my-6 flex justify-center items-start bg-blue-600 rounded-md cursor-pointer" id="input-test-text" >
